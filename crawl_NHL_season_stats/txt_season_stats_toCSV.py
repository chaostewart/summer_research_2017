...
for fileName in fileNameList:
	...
	fieldNames = ['PlayerID', 'PlayerName', 'Season', 'GameType', 'Team', 'Position', 'GP', 'G', 'A', 'P', 'PlusMinus', 'PIM', 'P/GP', 'PPG', 'PPP', 'SHG', 'SHP', 'GWG', 'OTG', 'S', 'S%', 'TOI/GP', 'TOI/GP_sec', 'Shifts/GP', 'FOW%' ]
